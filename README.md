...
- [`carding-car/`](carding-car/README.md)：独立 Git submodule，海湾基础素材及 [`expansion/`](carding-car/expansion/README.md) 的 7 场景、10 车型、10 车手、12 道具，包含 GLB、效果图、贴图和制作记录，可供其他项目复用。
